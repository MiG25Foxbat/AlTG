...
в `docs/project-context.md`. Ревизия стороннего техстека — в
`docs/tech-stack-review.md`. Читать оба по необходимости, не обязательно
в каждой сессии.
...
- GramJS официально в состоянии перехода/устаревания в пользу его
  преемников в экосистеме MTProto-клиентов на JS — если в будущем встанет
  вопрос миграции библиотеки, это не должно быть сюрпризом.
